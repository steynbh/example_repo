...
while True:
    if input_username in valid_credentials:
        if input_password == valid_credentials[input_username]:
            ...
            #make sure to break out of the loop if login is successful
            break
        else:
...
while True:
    ...
    while menu != 'e':
                ...
                # Add the following functionality: when the user chooses to generate reports, two text files, called task_overview.txt and user_overview.txt, should be generated. The reports should be generated from the data in user.txt and tasks.txt. The reports should be generated in the format described in the task_overview.txt and user_overview.txt sections of the PDF.
                # When the user chooses to display statistics, if the user is admin, they should be shown the total number of users and the total number of tasks. This information should be retrieved from user.txt and tasks.txt respectively. If the user is not admin, they should be shown an appropriate error message.  
